--- Summary
	...
	REPLACE INTO .. (..) VALUES (..)
	COUNT()
	MIN() ; ROUND() ; PI() ; FLOOR ; POWER ; SQRT ; TRUNCATE ;
		 RAND ; SIGN ; ABS ; MOD
	...
	STRCMP
	LPAD ; RPAD
	TRIM ; SUBSTRING ; LOWER ; LCASE ; UPPER ; UCASE
	REVERSE ; REPLACE ; CONCAT ; CONCAT_WS ; ASCII ; COUNT
	...
	DAY ; WEEK ; MONTH ; YEAR
		 DAYOFMONTH ; DAYOFWEEK ; WEEKDAY ; WEEKOFYEAR ; DAYNAME ; DAYOFYEAR
